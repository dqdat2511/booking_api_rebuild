...
public final class Constants {
    ...
    public static final String MESSAGE_DUPLICATED_FAIL = "This number phone has been already exit";
    ...
    public static final String MESSAGE_ADDED_SUCCESSFULLY = "Added! Welcome.";
